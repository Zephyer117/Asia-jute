          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <Link href="/" className="flex items-center group">
              <div className="flex items-center">
                ...
                <span className="text-2xl font-bold bg-gradient-to-r from-text-green/75  to-text-secondary bg-clip-text text-transparent">
                  International
                </span>
                </div>
              </div>
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`relative px-2 py-2 text-md font-semibold transition-all duration-300 ${
                    isActive(link.path) ? 'text-primary' : 'text-text-green-dark hover:text-text-primary'
                  } group`}
                >
                  {link.name}
                  <span 
                    className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r 
                      from-text-secondary to-text-green transform origin-left transition-transform duration-300 ${
            ...
            <button
              ...
              transition-colors z-[101] outline-none 
              ...
              <Link
                ...
                className={`block px-4 py-3 rounded-lg transition-all duration-300 font-medium text-lg ${
                  isActive(link.path)
                    ...
                    : 'text-text-secondary hover:bg-secondary/80 hover:text-text-primary font-bold'
                }`}
